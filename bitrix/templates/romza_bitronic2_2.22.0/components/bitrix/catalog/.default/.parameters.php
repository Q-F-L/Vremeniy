...
if (!empty($arCurrentValues['IBLOCK_ID']) && $arCurrentValues['HIDE_ITEMS_NOT_AVAILABLE'] == 'Y'){
...
$arTemplateParameters_common = array(
    ...
    'HIDE_ITEMS_NOT_AVAILABLE' => array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('HIDE_ITEMS_NOT_AVAILABLE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N',
        'REFRESH' => 'Y',
    ),
    ...
    'HIDE_ITEMS_ZER_PRICE' => array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('HIDE_ITEMS_ZER_PRICE'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ),
    'HIDE_ITEMS_WITHOUT_IMG' => array(
        'PARENT' => 'VISUAL',
        'NAME' => GetMessage('HIDE_ITEMS_WITHOUT_IMG'),
        'TYPE' => 'CHECKBOX',
        'DEFAULT' => 'N'
    ),
